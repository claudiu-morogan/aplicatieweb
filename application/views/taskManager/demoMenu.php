...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- Facebook and Twitter integration -->
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="<?=site_url();?>/assets-TaskManager/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="<?=site_url();?>/assets-TaskManager/css/icomoon.css">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="<?=site_url();?>/assets-TaskManager/css/magnific-popup.css">
	<!-- Salvattore -->
	<link rel="stylesheet" href="<?=site_url();?>/assets-TaskManager/css/salvattore.css">
	<!-- Theme Style -->
	<link rel="stylesheet" href="<?=site_url();?>/assets-TaskManager/css/style.css">
	<!-- Modernizr JS -->
	<script src="<?=site_url();?>/assets-TaskManager/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<!-- jQuery -->
	<script src="<?=site_url();?>/assets-TaskManager/js/jquery.min.js"></script>
	<!-- jQuery Easing -->
	<script src="<?=site_url();?>/assets-TaskManager/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="<?=site_url();?>/assets-TaskManager/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="<?=site_url();?>/assets-TaskManager/js/jquery.waypoints.min.js"></script>
	<!-- Magnific Popup -->
	<script src="<?=site_url();?>/assets-TaskManager/js/jquery.magnific-popup.min.js"></script>
	<!-- Salvattore -->
	<script src="<?=site_url();?>/assets-TaskManager/js/salvattore.min.js"></script>
	<!-- Main JS -->
	<script src="<?=site_url();?>/assets-TaskManager/js/main.js"></script>
