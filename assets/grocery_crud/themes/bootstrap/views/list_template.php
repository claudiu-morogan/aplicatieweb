...
<script type='text/javascript'>
    ...
    <br/>
    <div class="container gc-container" style="min-width: 1600px !important;">
        ...
        ?></div>
 		...
 		<div class="row">
        	<div class="col-md-12 table-section" style="position: initial;">
        					...
        					<thead>
        						<tr>
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <th class="column-with-ordering text-center" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                    <?php }?>
        						</tr>
